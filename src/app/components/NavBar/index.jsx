import { handleSelectNavBarMenu } from '../../../redux/features/sliceCallList';
import { useSelector, useDispatch } from 'react-redux';
import { Logo } from '../Logo';
import s from './NavBar.module.css';

import { PlusIcon } from '../IconsSVG/PlusIcon';
import { ExclamationMark } from '../IconsSVG/ExclamationMark';

export const NavBar = () => {
  const { numIsActiveNavBar } = useSelector((state) => state.callList);
  ...
  const menuList = [
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            d="M18 2.00009L16.59 0.590088L10.25 6.93009L11.66 8.34009L18 2.00009ZM22.24 0.590088L11.66 11.1701L7.48003 7.00009L6.07003 8.41009L11.66 14.0001L23.66 2.00009L22.24 0.590088ZM0.410034 8.41009L6.00003 14.0001L7.41003 12.5901L1.83003 7.00009L0.410034 8.41009Z"
            fill="white"
            fillOpacity="0.56"
          />
        </svg>
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            d="M8 2C9.1 2 10 2.9 10 4C10 5.1 9.1 6 8 6C6.9 6 6 5.1 6 4C6 2.9 6.9 2 8 2ZM8 11C10.7 11 13.8 12.29 14 13V14H2V13.01C2.2 12.29 5.3 11 8 11V11ZM8 0C5.79 0 4 1.79 4 4C4 6.21 5.79 8 8 8C10.21 8 12 6.21 12 4C12 1.79 10.21 0 8 0V0ZM8 9C5.33 9 0 10.34 0 13V16H16V13C16 10.34 10.67 9 8 9V9Z"
            fill="white"
            fillOpacity="0.6"
          />
        </svg>
        ...
        {menuList.map((menuItem) => (
          <li
            ...
            className={`${s.menu_item} ${
              numIsActiveNavBar === menuItem.id ? s.active : ''
            } ${s.newMessageInCall}`}
            onClick={() => dispatch(handleSelectNavBarMenu(menuItem.id))}
          >
            <span className={s.menu_icon}>{menuItem.icon}</span>
            <span className={s.menu_text}>{menuItem.name}</span>
          </li>
        ))}
      </ul>
      <div className={s.add_order_btn}>
        <span>Добавить заказ</span>
        <PlusIcon color={'#D8E4FB'} opacity={'0.56'} />
      </div>
